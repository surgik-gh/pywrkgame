...
source.include_exts = py,png,jpg,kv,atlas,cpp,h,hpp,c

# (list) List of inclusions using pattern matching
source.include_patterns = assets/*,assets/*/*,python/*,src/*,include/*

# (list) Source files to exclude (let empty to not exclude anything)
#source.exclude_exts = spec

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = tests,bin,build,.git,.github,docs,examples
...
requirements = python3,pybind11,numpy
